...
export const AI_MODEL_OPTIONS = {
	openai: [
		{ id: "gpt-5.4-mini", label: "GPT-5.4 Mini", description: "GPT-5 系列均衡推荐，成本与质量兼顾" },
		{ id: "gpt-5.5", label: "GPT-5.5", description: "OpenAI 当前旗舰通用/推理模型" },
		{ id: "gpt-5.5-pro", label: "GPT-5.5 Pro", description: "高强度推理与复杂任务" },
	...
	anthropic: [
		{ id: "claude-sonnet-4-6", label: "Claude Sonnet 4.6", description: "主力均衡模型，通用推荐" },
	...
	deepseek: [
		{ id: "deepseek-v4-flash", label: "DeepSeek V4 Flash", description: "快速通用模型，通用推荐" },
		{ id: "deepseek-v4-pro", label: "DeepSeek V4 Pro", description: "当前高性能模型" },
	],
	zhipu: [
		{ id: "glm-5.1", label: "GLM-5.1", description: "智谱最新主线文本模型，通用推荐" },
		{ id: "glm-5", label: "GLM-5", description: "智谱高端通用模型" },
		...
		{ id: "glm-4.5-flash", label: "GLM-4.5 Flash", description: "快速低成本轻量模型" },
		{ id: "glm-4.6", label: "GLM-4.6", description: "稳定通用版本" },
	],
	siliconflow: [
		{ id: "Qwen/Qwen3-32B", label: "Qwen3 32B", description: "均衡通用模型，通用推荐" },
		{ id: "Pro/zai-org/GLM-5", label: "GLM-5 (Pro)", description: "SiliconFlow 高端 GLM 路线模型" },
		{ id: "Pro/zai-org/GLM-4.7", label: "GLM-4.7 (Pro)", description: "强化 Coding 与 Agent 场景" },
		{ id: "deepseek-ai/DeepSeek-V3.2", label: "DeepSeek V3.2", description: "通用主线模型" },
	...
	xai: [
		{ id: "grok-4.3", label: "Grok 4.3", description: "xAI 当前推荐模型" },
