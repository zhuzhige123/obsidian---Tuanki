...
describe('i18n audit', () => {
  ...
  it('keeps cleared bilingual hotspots free of new hardcoded Chinese UI text', () => {
    ...
    const hotspotFiles = [
      ...
      'src/components/pages/DeckStudyPage.svelte',
      'src/components/question-bank/QuestionBankStudyInterface.svelte',
      'src/components/modals/tabs/IRCardInfoTab.svelte',
      'src/components/modals/tabs/IRCardScheduleTab.svelte',
      'src/components/modals/CardToMarkdownModal.svelte',
      'src/components/ui/FolderSuggestModal.svelte',
      'src/components/preview/PreviewContainer.svelte',
      'src/components/markdown/WeaveDeckCodeBlock.svelte',
      'src/components/views/GridTimelineView.svelte',
      'src/components/filters/AdvancedFilterBuilder.svelte',
      'src/components/filters/FilterConditionRow.svelte',
      'src/components/preview/cards/MultipleChoiceCard.svelte',
      'src/components/atoms/ObsidianRenderer.svelte',
      'src/components/ui/FileDropZone.svelte',
      'src/components/ui/MarkdownEditor.svelte',
      'src/components/ui/ReviewTimeline.svelte',
      'src/components/ui/CardSourceInfo.svelte',
      'src/components/ui/ErrorBoundary.svelte',
      'src/components/ui/FriendlyErrorDisplay.svelte',
      'src/components/ui/ResizableModal.svelte',
      'src/components/editors/MarkdownEditor.svelte',
      'src/components/study/StudySessionModalHost.svelte',
      'src/components/question-bank/QuestionBankSessionModalHost.svelte',
      'src/components/ui/SearchBar.svelte',
      'src/components/ui/Select.svelte',
      'src/components/ui/ObsidianDropdown.svelte',
      'src/components/ui/TagInputField.svelte',
      'src/components/ui/BottomSheetModal.svelte',
      'src/components/ui/SmartTooltip.svelte',
      'src/components/ui/InteractiveStepIndicator.svelte',
      'src/components/atoms/ChoiceOptionRenderer.svelte',
      'src/components/tables/components/ColumnResizer.svelte',
      'src/components/tables/components/TableSortingOverlay.svelte',
      'src/components/tables/components/TableCheckbox.svelte',
      'src/components/image-mask/ImageMaskModal.svelte',
      'src/components/image-mask/MaskEditorSVG.svelte',
      'src/components/image-mask/MaskShapeV2.svelte',
      'src/data/storage.ts',
      'src/application/services/apkg/APKGImportService.ts',
      'src/domain/apkg/parser/APKGParser.ts',
      'src/main.ts',
    ];
